  ...
  template: {
    ...
    cognitive: [
      { id: 'e_cg1', text: '商品資訊是否過多，造成使用者無法聚焦？', checked: false, suggestion: '分段呈現、逐步顯示' },
      { id: 'e_cg2', text: '商品分類與架構是否清晰？', checked: false, suggestion: '優化：多層分類、麵包屑導航' },
      { id: 'e_cg3', text: '用語是否一致？是否存在專業術語或翻譯問題？', checked: false, suggestion: '建立用語字典、統一翻譯' },
      { id: 'e_cg4', text: '購物流程是否符合使用者的認知模型？', checked: false, suggestion: '參考常見模式、降低學習成本' },
      { id: 'e_cg5', text: '是否提供足夠的引導與說明？', checked: false, suggestion: '工具提示、逐步教學' }
    ],
    emotional: [
      { id: 'e_em1', text: '使用者是否在結帳過程中感到焦慮或不確定？', checked: false, suggestion: '即時回饋、清楚錯誤訊息' },
      { id: 'e_em2', text: '是否有錯誤處理不清楚，造成挫折感？', checked: false, suggestion: '具體修正建議、重試選項' },
  ...
  template: {
    ...
    cognitive: [
      { id: 'ed_cg1', text: '課程資訊是否過多，造成學員無法聚焦？', checked: false, suggestion: '分段呈現、逐步顯示' },
      { id: 'ed_cg2', text: '課程架構是否清晰？章節與單元是否容易理解？', checked: false, suggestion: '優化：樹狀結構、進度導覽' },
      { id: 'ed_cg3', text: '用語是否一致？是否存在專業術語或翻譯問題？', checked: false, suggestion: '建立用語字典、統一翻譯' },
      { id: 'ed_cg4', text: '學習流程是否符合學員的認知模型？', checked: false, suggestion: '參考常見學習模式、降低學習成本' },
      { id: 'ed_cg5', text: '是否提供足夠的引導與說明？', checked: false, suggestion: '工具提示、逐步教學' }
    ],
    emotional: [
      { id: 'ed_em1', text: '學員是否在學習過程中感到焦慮或不確定？', checked: false, suggestion: '即時回饋、清楚錯誤訊息' },
      { id: 'ed_em2', text: '是否有作業或考試壓力過大，造成挫折感？', checked: false, suggestion: '彈性：分段測驗、即時提示' },
  ...
  template: {
    ...
    cognitive: [
      { id: 'ob_cg1', text: '引導資訊是否過多，造成使用者無法聚焦？', checked: false, suggestion: '分段呈現、逐步顯示' },
      { id: 'ob_cg2', text: '引導架構是否清晰？使用者能否理解流程層級？', checked: false, suggestion: '優化：步驟分組、進度導覽' },
      { id: 'ob_cg3', text: '用語是否一致？是否存在專業術語或翻譯問題？', checked: false, suggestion: '建立用語字典、統一翻譯' },
      { id: 'ob_cg4', text: '引導流程是否符合使用者的認知模型？', checked: false, suggestion: '參考常見模式、降低學習成本' },
      { id: 'ob_cg5', text: '是否提供足夠的引導與說明？', checked: false, suggestion: '工具提示、逐步教學' }
    ],
    emotional: [
      { id: 'ob_em1', text: '使用者是否在引導過程中感到焦慮或不確定？', checked: false, suggestion: '即時回饋、清楚錯誤訊息' },
      { id: 'ob_em2', text: '是否有過多步驟造成挫折感？', checked: false, suggestion: '簡化：減少步驟、提供跳過選項' },
  ...
  template: {
    ...
    cognitive: [
      { id: 'saas_cg1', text: '功能與設定是否過於複雜，造成使用者理解困難？', checked: false, suggestion: '簡化：分步設定、預設模板' },
      { id: 'saas_cg2', text: '儀表板資訊是否過載，使用者能否聚焦關鍵數據？', checked: false, suggestion: '優化：資訊分層、可自訂視圖' },
      { id: 'saas_cg3', text: '用語是否一致？是否存在專業術語或翻譯問題？', checked: false, suggestion: '建立用語字典、統一翻譯' },
      { id: 'saas_cg4', text: '操作流程是否符合使用者的認知模型？', checked: false, suggestion: '參考常見模式、降低學習成本' },
      { id: 'saas_cg5', text: '是否提供足夠的引導與說明？', checked: false, suggestion: '工具提示、逐步教學' }
    ],
    emotional: [
      { id: 'saas_em1', text: '使用者是否在設定或操作過程中感到焦慮或不確定？', checked: false, suggestion: '即時回饋、清楚錯誤訊息' },
      { id: 'saas_em2', text: '是否有訂閱或付款流程造成挫折感？', checked: false, suggestion: '透明：清楚方案比較、簡單付款' },
  ...
  template: {
    ...
    cognitive: [
      { id: 'cg1', text: '資訊是否過多，造成使用者無法聚焦？', checked: false, suggestion: '分段呈現、逐步顯示' },
      { id: 'cg2', text: '資訊架構是否清晰？使用者能否快速理解層級？', checked: false, suggestion: '優化：卡片分類、樹狀結構' },
      { id: 'cg3', text: '用語是否一致？是否存在專業術語或翻譯問題？', checked: false, suggestion: '建立用語字典、統一翻譯' },
      { id: 'cg4', text: '操作流程是否符合使用者的認知模型？', checked: false, suggestion: '參考常見模式、降低學習成本' },
      { id: 'cg5', text: '是否提供足夠的引導與說明？', checked: false, suggestion: '工具提示、逐步教學' }
    ],
    emotional: [
      { id: 'em1', text: '使用者是否在操作過程中感到焦慮或不確定？', checked: false, suggestion: '即時回饋、清楚錯誤訊息' },
      { id: 'em2', text: '是否有過多步驟造成挫折感？', checked: false, suggestion: '簡化：減少步驟、提供跳過選項' },
